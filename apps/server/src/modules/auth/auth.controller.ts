...
export class AuthController {
    ...
    public login = async (request: Request<object, object, LoginRequestDtoType>, response: Response) => {
        const authResult = await this.AuthService.login(request.context, request.body, response);
    ...
    public signup = async (request: Request<object, object, SignupRequestDtoType>, response: Response) => {
        const authResult = await this.AuthService.signup(request.context, request.body, response);
        let rawResponse;
    ...
    public refreshAccessToken = async (request: Request, response: Response) => {
        const result = await this.AuthService.refreshAccessToken(request.context, response);
    ...
    public sendVerificationEmail = async (
        ...
        const result = await this.AuthService.sendVerificationEmail(request.context, request.body);
        const rawResponse = {
            status: StatusCodes.OK,
    ...
    public verifyVerificationToken = async (
        ...
        await this.AuthService.verifyVerificationToken(request.context, request.query);
        const rawResponse = {
            status: StatusCodes.OK,
    ...
    public sendResetPasswordEmail = async (
        ...
        const result = await this.AuthService.sendResetPasswordEmail(request.context, request.body);
        const rawResponse = {
            status: StatusCodes.OK,
            message:
    ...
    public resetPassword = async (
        request: Request<object, object, VerifyRTokenRequestBodyDtoType, VerifyRTokenRequestQueryDtoType>,
        response: Response,
    ) => {
