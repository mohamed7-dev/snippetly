...
export const loginRouteConfig: RouteConfig = {
    ...
    responses: {
        ...
        401: {
            description: 'Response body if user was not found, or the password was invalid',
            content: {
                'application/json': {
...
export const refreshTokenRouteConfig: RouteConfig = {
    ...
    responses: {
        200: {
            description: 'Response body if the access token was refreshed successfully',
            content: {
                'application/json': {
...
export const sendVEmailRouteConfig: RouteConfig = {
    ...
    responses: {
        ...
        401: {
            description: 'Response body user account associated with the email is not found.',
            content: {
                'application/json': {
                    schema: UnauthorizedErrorResponseDto,
                },
        ...
        400: {
            description: 'Response body if request body was invalid e.g. missing email',
            content: {
                'application/json': {
                    schema: BadRequestErrorResponseDto,
                },
...
export const verifyVEmailRouteConfig: RouteConfig = {
    ...
    summary: "Endpoint to verify the email verification token that was sent to the user's email",
    tags: ['Auth'],
    request: {
    ...
    responses: {
        200: {
            description: 'Response body if email verification token was verified successfully',
            content: {
                'application/json': {
...
export const sendREmailRouteConfig: RouteConfig = {
    ...
    responses: {
        200: {
            description: 'Response body if the password reset link was sent successfully',
            content: {
                'application/json': {
        ...
        401: {
            description: 'Response body if the user account associated with the email is not found',
            content: {
                'application/json': {
                    schema: UnauthorizedErrorResponseDto,
                },
...
export const resetPasswordRouteConfig: RouteConfig = {
    ...
    summary: "Endpoint to verify the password reset token that was sent to the user's email",
    tags: ['Auth'],
    request: {
    ...
    responses: {
        200: {
            description: 'Response body if the password reset token was verified successfully',
            content: {
                'application/json': {
