...
export const getCollectionRouteConfig: RouteConfig = {
    ...
    responses: {
        200: {
            ...
            content: {
                'application/json': {
                    schema: GetCollectionOwnerSuccessResDto.or(GetCollectionPublicSuccessResDto),
                },
            },
        },
        400: {
...
export const getUserCollectionsRouteConfig: RouteConfig = {
    ...
    responses: {
        200: {
            ...
            content: {
                'application/json': {
                    schema: GetUserCollectionsOwnerSuccessResDto.or(GetUserCollectionsPublicSuccessResDto),
                },
            },
        },
        400: {
