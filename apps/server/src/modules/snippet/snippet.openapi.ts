...
export const getSnippetRouteConfig: RouteConfig = {
    ...
    responses: {
        200: {
            ...
            content: {
                'application/json': {
                    schema: GetSnippetSuccessOwnerResDto.or(GetSnippetSuccessPublicResDto),
                },
            },
        },
        400: {
...
export const getCollectionSnippetsRouteConfig: RouteConfig = {
    ...
    responses: {
        ...
        400: {
            description: 'Response body if the request params or query params were invalid',
            content: {
                'application/json': {
                    schema: BadRequestErrorResponseDto,
                },
...
export const getUserSnippetsRouteConfig: RouteConfig = {
    ...
    responses: {
        200: {
            ...
            content: {
                'application/json': {
                    schema: GetUserSnippetsSuccessOwnerResDto.or(GetUserSnippetsSuccessPublicResDto),
                },
            },
        },
        400: {
...
export const getUserFriendsSnippetsRouteConfig: RouteConfig = {
    ...
    responses: {
        ...
        400: {
            description: 'Response body if the request query params or params were invalid',
            content: {
                'application/json': {
                    schema: BadRequestErrorResponseDto,
                },
