...
export const sendFriendshipRequestRouteConfig: RouteConfig = {
    ...
    responses: {
        200: {
            description: 'Response body if the friendship request was sent successfully',
            content: {
                'application/json': {
...
export const acceptFriendshipRequestRouteConfig: RouteConfig = {
    ...
    responses: {
        200: {
            description: 'Response body if the friendship request was accepted successfully',
            content: {
                'application/json': {
...
export const rejectFriendshipRequestRouteConfig: RouteConfig = {
    ...
    responses: {
        200: {
            description: 'Response body if the friendship request was rejected successfully',
            content: {
                'application/json': {
...
export const cancelFriendshipRequestRouteConfig: RouteConfig = {
    ...
    responses: {
        200: {
            description: 'Response body if the friendship request was cancelled successfully',
            content: {
                'application/json': {
