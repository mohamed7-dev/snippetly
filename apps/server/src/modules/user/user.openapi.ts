...
export const getCurrentUserProfileRouteConfig: RouteConfig = {
    ...
    responses: {
        200: {
            description: 'Response body if the user profile info was fetched successfully',
            content: {
                'application/json': {
...
export const discoverUsersRouteConfig: RouteConfig = {
    method: 'get',
    path: '/users/discover',
    summary: 'Endpoint to discover potential friends, and navigate through their snippets',
    tags: ['Users'],
    request: {
        headers: protectedRouteHeadersSchema,
        cookies: protectedRouteCookiesSchema,
