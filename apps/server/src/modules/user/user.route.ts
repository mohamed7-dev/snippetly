...
export class UserRoute implements Route {
    ...
    public FriendshipController: FriendshipController = new FriendshipController();
    ...
    private initializeRoutes() {
        ...
        this.router.delete(`${this.path}`, userWriteLimiter, authMiddleware, this.controller.delete);
