...
export class AuthService {
  ...
  public async login(
    ...
    if (refreshToken) {
      ...
      */
      const foundToken =
        await this.UserReadService.findOneByRefreshToken(refreshToken);
  ...
  public async sendVerificationEmail(
    _ctx: RequestContext,
    input: SendVEmailRequestDtoType,
    user?: User
  ) {
    const { email } = input;
  ...
  public async verifyVerificationToken(
    _ctx: RequestContext,
    input: VerifyVTokenRequestDtoType
  ) {
  ...
  public async sendResetPasswordEmail(
    _ctx: RequestContext,
    input: SendRTokenRequestDtoType
  ) {
    const { email } = input;
