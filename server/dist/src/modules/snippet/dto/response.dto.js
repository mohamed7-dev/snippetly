...
export const CreateSnippetResDto = CommonMutateSchema.omit({
    ...
    const { slug, createdAt, collectionId, creatorId, collectionPublicId, creatorName, ...rest } = val;
    return {
        ...rest,
        publicId: slug,
        addedAt: createdAt,
...
export const UpdateSnippetResDto = CommonMutateSchema.transform((val)=>{
    const { slug, createdAt, updatedAt, collectionId, creatorId, collectionPublicId, creatorName, forkedFrom, ...rest } = val;
    return {
        ...rest,
        publicId: slug,
        addedAt: createdAt,
...
export const GetSnippetsByCollectionResDto = z.object({
    snippets: z.array(BaseSnippetsCollectionSchema.shape.snippet.transform((val)=>{
        const { creator: { name, ...creatorRest }, collectionId, createdAt, updatedAt, forkedFrom, slug, ...rest } = val;
        return {
            ...rest,
            publicId: slug,
            addedAt: createdAt,
...
export const GetPublicSnippetsByCollectionResDto = z.object({
    snippets: z.array(BaseSnippetsCollectionSchema.shape.snippet.omit({
        forkedFrom: true,
        isPrivate: true,
        updatedAt: true
    }).transform((val)=>{
        const { creator: { name, ...creatorRest }, collectionId, createdAt, slug, ...rest } = val;
        return {
            ...rest,
            publicId: slug,
            addedAt: createdAt,
...
// Discover Snippets
export const DiscoverSnippetsResDto = z.array(SelectSnippetDto.pick({
    title: true,
    slug: true,
    code: true,
    language: true,
    ...
    const { creator: { name, ...restCreator }, collection: { slug: collectionSlug, ...restCollection }, createdAt, slug, ...rest } = val;
    return {
        ...rest,
        publicId: slug,
        addedAt: createdAt,
...
export const GetCurrentUserSnippetsResDto = z.array(CommonUserSnippetsSchema.transform((val)=>{
    const { creator: { name, ...restCreator }, collection: { slug: collectionSlug, ...restCollection }, createdAt, updatedAt, forkedFrom, slug, ...rest } = val;
    return {
        ...rest,
        publicId: slug,
        addedAt: createdAt,
...
// Get User Snippets
export const GetUserSnippetsResDto = z.array(CommonUserSnippetsSchema.omit({
    forkedFrom: true,
    updatedAt: true
}).transform((val)=>{
    const { creator: { name, ...restCreator }, collection: { slug: collectionSlug, ...restCollection }, createdAt, slug, ...rest } = val;
...
export const GetCurrentUserFriendsSnippetsResDto = z.array(CommonUserSnippetsSchema.omit({
    updatedAt: true,
    forkedFrom: true,
    isPrivate: true
}).transform((val)=>{
...
// Get Snippet
export const GetSnippetResDto = CommonUserSnippetsSchema.extend(SelectSnippetDto.pick({
    note: true
}).shape).transform((val)=>{
    const { creator: { name, ...restCreator }, collection: { slug: collectionSlug, ...restCollection }, createdAt, updatedAt, forkedFrom, slug, ...rest } = val;
    return {
