...
export class UserRoute {
    ...
    initializeRoutes() {
        ...
        // --- user PUT/DELETE ---
        this.router.put(`${this.path}`, authMiddleware, // this.configureMulter().single("image"), // deploying on vercel
        zodValidatorMiddleware(UpdateUserDto.omit({
            image: true,
            imageCustomId: true,
            imageKey: true
        }), "Body"), this.controller.update);
