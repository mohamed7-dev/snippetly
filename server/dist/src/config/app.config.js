...
if (!ACCESS_JWTOKEN_SECRET || !REFRESH_JWTOKEN_SECRET) {
    throw new HttpException(StatusCodes.INTERNAL_SERVER_ERROR, "Missing ACCESS_JWTOKEN_SECRET or REFRESH_JWTOKEN_SECRET Env Variables.");
}
export const JWT_ACCESS_EXPIRES = isDevelopment ? 7 * 24 * 60 * 60 * 1000 // 7 days
 : 15 * 60 * 1000; // 15 minutes;
export const JWT_REFRESH_EXPIRES = isDevelopment ? 7 * 24 * 60 * 60 * 1000 // 7 days
 : 7 * 24 * 60 * 60 * 1000; // 7 days;
export const JWT_REFRESH_REMEMBER_EXPIRES = isDevelopment ? 30 * 24 * 60 * 60 * 1000 // 7 days
